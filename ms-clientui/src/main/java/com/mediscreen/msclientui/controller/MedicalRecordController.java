...
public class MedicalRecordController {
	...
	public ResponseEntity<MedicalRecord> createMedicalRecord(HttpSession session,
			@PathVariable(value = "id") Integer id, @ModelAttribute MedicalRecord medicalRecord) {
		try {
	...
	public ResponseEntity<Void> updateMedicalRecord(HttpSession session, @RequestParam(value = "id") String id,
			@RequestParam(value = "patientId") Integer patientId, @RequestParam(value = "active") Boolean active) {
		try {
