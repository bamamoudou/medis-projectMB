...
import com.mediscreen.mediscreenclientui.utils.FileUtils;
...
public class Patient {
	...
	public String getProfilePictureExt() {
		return new FileUtils().getFileExtention("mediscreen-clientui/src/main/resources/static/assets/profilePicture/"
				+ this.getId() + "_" + this.getFirstname() + "_" + this.getLastname(), "img");
	}
}