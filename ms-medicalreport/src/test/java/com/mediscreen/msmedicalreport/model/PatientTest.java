...
class PatientTest {
	...
	private LocalDate birthday = LocalDate.of(LocalDate.now().getYear() - 20, LocalDate.now().getMonthValue(),
	...
	void set_test() {
		...
		LocalDate newBirthday = LocalDate.of(LocalDate.now().getYear() - 33, LocalDate.now().getMonthValue(),
				LocalDate.now().getDayOfMonth());
