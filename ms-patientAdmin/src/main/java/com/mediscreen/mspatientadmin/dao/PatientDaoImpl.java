...
import com.mediscreen.mspatientadmin.configuration.DatabaseConfigurationInterface;
...
public class PatientDaoImpl extends DaoManager implements PatientDao {
	 ...
	 * Constructor
	 */
	public PatientDaoImpl(DatabaseConfigurationInterface databaseConfiguration) {
	...
	/**
	 * @see PatientDao {@link #getAllPatient()}
	 */
	@Override
	...
	/**
	 * @see PatientDao {@link #updatePatient(Patient)}
	 */
	@Override
	...
	/**
	 * @see PatientDao {@link #createPatient(Patient)}
	 */
	@Override
	...
	/**
	 * @see PatientDao {@link #searchPatients(String)}
	 */
	@Override
	...
	/**
	 * @see PatientDao {@link #deletePatientById(Integer)}
	 */
	@Override
